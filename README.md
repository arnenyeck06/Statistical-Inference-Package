...
I prepared, transformed, and modeled clinical healthcare data for predicting the risk of gestational diabetes mellitus (GDM). The focus is on data reliability, preprocessing at scale, and model-ready datasets, rather than only model accuracy.
