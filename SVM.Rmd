...
#Read files
data <- read.csv("C:/Users/ERC/Desktop/completed_data_rf 1.csv")
...
feature_cols <- c("Pregnancies", "Glucose", "BloodPressure", "SkinThickness", 
                  "log_Insulin", "BMI", "log_Pedigree", "Age")
...
# Compute ROC
roc_val   <- tryCatch({
  pROC::roc(test_svm$Diagnosis, test_pred_prob_tuned, quiet = TRUE)$auc
}, error = function(e) NA)
